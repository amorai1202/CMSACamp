...
```{r, ptype_counts, echo = FALSE, fig.align='center', fig.height=6, fig.width=12, out.width='75%'}
library(patchwork)
...
```{r cluster players, include = FALSE}
...
```{r, include = FALSE}
data.frame(best_batters) %>% 
  knitr::kable(format = 'html')#group of strongest batters this season in terms of further hit distance and highest launch speed
```
